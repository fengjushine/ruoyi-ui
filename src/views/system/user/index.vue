<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否激活，1：是，0：否" prop="active">
        <el-input
          v-model="queryParams.active"
          placeholder="请输入是否激活，1：是，0：否"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否激活，1：是，0：否" align="center" prop="active" />
      <el-table-column label="状态，1：使用，0：停用" align="center" prop="status" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否激活，1：是，0：否" prop="active">
          <el-input v-model="form.active" placeholder="请输入是否激活，1：是，0：否" />
        </el-form-item>
        <el-form-item label="用户角色" prop="roleId">
          <el-input v-model="form.roleId" placeholder="请输入用户角色" />
        </el-form-item>
        <el-form-item label="修改时间" prop="modifyTime">
          <el-date-picker clearable
  ...
  data() {
    return {
      ...
      rules: {
        ...
        active: [
          { required: true, message: "是否激活，1：是，0：否不能为空", trigger: "blur" }
        ],
        createTime: [
